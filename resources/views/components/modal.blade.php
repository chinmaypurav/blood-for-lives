                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                <!-- Donation ID -->
                                <div class="mt-4">
                                    <x-label for="transactionId" :value="__('Transaction ID')" />

                                    <x-input id="transactionId" class="block mt-1 w-full" type="transactionId" name="transactionId" :value="old('transactionId')" required />
                                </div>
                                {{ $slot }}
                            </p>
                        </div>
