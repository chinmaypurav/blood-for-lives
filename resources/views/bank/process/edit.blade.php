                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('manager.donation.store') }}">
                        ...
                        <div>
                            ...
                            <x-input id="qrCode" class="block mt-1 w-full" type="text" name="name" value="{{$donor->donor_card_no}}" readonly />
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            @if ($donatedAt)
                                <x-input id="donatedAt" class="block mt-1 w-full" 
                                                        type="date" 
                                                        name="donatedAt" 
                                value="{{Carbon\Carbon::parse($donatedAt)->format('Y-m-d')}}" readonly />
                            @else
                                <x-input id="donatedAt" class="block mt-1 w-full" 
                                                        type="text" 
                                                        name="donatedAt" 
